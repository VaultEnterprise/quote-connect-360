...
export default function MetricCard({ label, value, icon: Icon, trend, trendLabel, className }) {
  return (
    <Card className={cn("group relative overflow-hidden border-border/70 bg-card/95 p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md", className)}>
