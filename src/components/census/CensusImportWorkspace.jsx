...
export default function CensusImportWorkspace({ open, onClose, caseId, onComplete }) {
  ...
  return (
    <Dialog open={open} onOpenChange={(nextOpen) => { if (!nextOpen) { resetState(); onClose(); } }}>
      <DialogContent className="max-w-6xl max-h-[92vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Census Import Workspace</DialogTitle>
        </DialogHeader>
