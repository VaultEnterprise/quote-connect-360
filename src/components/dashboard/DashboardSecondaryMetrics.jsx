...
export default function DashboardSecondaryMetrics({ summary, currentEnrollments, upcomingRenewalsCount }) {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card><CardContent className="p-4"><p className="text-xs text-muted-foreground mb-1">Upcoming Renewals (90d)</p><p className="text-xl font-bold text-amber-600">{upcomingRenewalsCount}</p></CardContent></Card>
